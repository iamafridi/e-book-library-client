...
const Banner = () => {
  return (
    <section className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      {/* Overlay */}
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 text-center backdrop-brightness-75">
        {/* Logo */}
        <img
          src={img}
          alt="Logo"
        ...
        <div className="mt-6 mb-10 flex flex-wrap justify-center gap-4 px-2">
          <Link to="/login">
            <button className="bg-gray-950 text-white px-5 py-2 rounded-xl text-sm hover:bg-gray-700 transition">
              Get Started
            </button>
          </Link>
          <Link to="/about">
            <button className="border border-white text-white px-5 py-2 rounded-xl text-sm hover:bg-white hover:text-black transition">
              Learn More
            </button>
          </Link>
        </div>
